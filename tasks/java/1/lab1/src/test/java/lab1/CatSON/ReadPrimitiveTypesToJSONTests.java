...
public class ReadPrimitiveTypesToJSONTests {
    ...
    void booleanToJson() {
        ...
        assertEquals("true", CatSON.toJson(Boolean.TRUE));
        assertEquals("false", CatSON.toJson(Boolean.FALSE));
    }
    ...
    void floatNanInfinityToJson() {
        ...
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Float.NaN));
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Float.POSITIVE_INFINITY));
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Float.NEGATIVE_INFINITY));
    }
    ...
    void doubleNanInfinityToJson() {
        ...
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Double.NaN));
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Double.POSITIVE_INFINITY));
        assertThrows(IllegalArgumentException.class, () -> CatSON.toJson(Double.NEGATIVE_INFINITY));
    }
